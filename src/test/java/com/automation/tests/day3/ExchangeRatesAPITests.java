...
public class ExchangeRatesAPITests {
    ...
    public void getLatestRates2() {
        ...
        //this line retunrs today's date in the required format: yyyy-MM-dd
    ...
    public void getHistoryOfRates() {
        ...
        //and() doesn't have a functional rate, it's just a syntax sugar
