...
// if variables are private they are not directly accessible through the object
// we encapsulate properties we make them not accessible outside the class
// it is a design approach, variables must be accessed via mutators (getter, setter)
// some variables should not be modified, so they don't have setters, they have only getter
